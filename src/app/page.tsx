...
export default function Home() {
  ...
  return (
    <div className={`flex flex-col items-center font-sans gap-0 lg:gap-40 p-16 overflow-hidden transition-all duration-1000 ease-out ${
      isLoaded 
      ...
      <section id="home" ref={homeSection.ref} className={`w-full flex flex-col items-center min-h-screen transition-all duration-1000 ease-out ${
        ...
        <h1 className="text-2xl lg:text-4xl font-bold  text-center max-w-3xl mt-25" style={{background: "linear-gradient(to right, #c94b4b, #4b134f)", backgroundClip: "text", WebkitBackgroundClip: "text", color:"transparent", textShadow: "0 5px 15px rgba(145, 92, 182, .4)"}} >Welcome to My Website</h1>
        <h1 className="text-3xl lg:text-6xl font-bold  text-center max-w-4xl" style={{background: "linear-gradient(to right, #c94b4b, #4b134f)", backgroundClip: "text", WebkitBackgroundClip: "text", color:"transparent",textShadow: "0 5px 15px rgba(145, 92, 182, .4) "}} >Hello, My Name is Kurt!</h1>
        <div className="flex flex-col lg:flex-row items-center mt-30 gap-8 lg:mt-80">
          <Image 
            src="/foto-porto.jpg" alt="Profile Picture" 
            width={300} 
            height={300} 
            className="rounded-full w-50 h-50 lg:w-80 lg:h-80 border-white shadow-lg aspect-square object-cover z-5"
            style={{boxShadow : "0 5px 15px rgba(145, 92, 182, .4)",}}/>
          <p
            className="text-lg font-bold justify-center text-white max-w-4xl text-justify lg:text-justify z-0 lg:text-xl "
      ...
      <section id="about" ref={interestsSection.ref} className={`w-full flex flex-col items-center py-20 transition-all duration-1000 ease-out ${
        interestsSection.isIntersecting 
          ? 'opacity-100 translate-y-0' 
          : 'opacity-0 translate-y-20'
      }`}>
        <div className={`mt-1 mb-0 transition-all duration-1000 ease-out delay-200 ${
          interestsSection.isIntersecting 
            ? 'opacity-100 translate-y-0' 
            : 'opacity-0 translate-y-20'
        }`}>
      ...
      <section ref={projectsSection.ref} className={`w-full flex flex-col items-center py-20 transition-all duration-1000 ease-out ${
        projectsSection.isIntersecting 
          ? 'opacity-100 translate-y-0' 
          : 'opacity-0 translate-y-20'
      }`}>
        <div className={`mt-0 transition-all duration-1000 ease-out ${
          projectsSection.isIntersecting 
            ? 'opacity-100 translate-y-0' 
            : 'opacity-0 translate-y-20'
        }`}>
      ...
      <section ref={experiencesSection.ref} className={`w-full flex flex-col items-center py-20 transition-all duration-1000 ease-out ${
